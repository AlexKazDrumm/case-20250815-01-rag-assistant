...
Помощник для ответов на вопросы потенциальных клиентов the source site по материалам сайта (кейсы/статьи).  
...
git clone <YOUR_REPO_URL> rag-assistant
cd rag-assistant
...
```
# примеры
https://example.com/cases/chat-boty/hr-bot-dlya-magnit-kotoriy-priglashaet-na-sobesedovanie
https://example.com/cases/kazanexpress-poisk-tovarov-po-foto
https://example.com/cases/kazanexpress-sistema-rekomendacij-na-sayte
```
...
- Иногда LLM склонна к общим формулировкам. Это ограничение частично компенсируется подсказками и контекстом; для дальнейшего улучшения подходят query rewriting, увеличение числа фрагментов и reranking.
